 ...
 * @author Joseph
 */
@WebFilter(filterName = "NoCacheFilter", urlPatterns = {"/*"}, servletNames = {"Faces Servlet"})
public class NoCacheFilter implements Filter {
    ...
    /*
     * Filter for making sure the browser does doesnt cahce jsf pages
     *      * 
     */
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        //System.out.println("NoCacheFilter Called");
