...
import paygate.objects.StatusFacade;
...
public class StatusController implements Serializable {
    ...
    @EJB
    private paygate.objects.StatusFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        List<Status> statusList = ejbFacade.findAll();
        SelectItem[] statuses = new SelectItem[statusList.size()];
        Iterator i = statusList.iterator();
        int x = 0;
        while (i.hasNext()) {
            Status status = (Status) i.next();
            statuses[x++] = new SelectItem(status, status.getDescription());
        }
        return statuses;
    ...
    public static class StatusControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Status) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + StatusController.class.getName());
            }
        }
    }
}
