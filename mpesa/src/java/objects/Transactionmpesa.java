...
@NamedQueries({
    ...
    @NamedQuery(name = "Transactionmpesa.findByUser", query = "SELECT t FROM Transactionmpesa t WHERE t.user = :user"),
...
public class Transactionmpesa implements Serializable {
    ...
    public BigInteger getMpesaamt() {
        return mpesaamt;
    }

    public void setMpesaamt(BigInteger mpesaamt) {
        this.mpesaamt = mpesaamt;
    }
    ...
    public String toString() {
        return "objects.Transactionmpesa[ id=" + id + " ]";
    }
