...
public class SiteuserJpaController implements Serializable {
    ...
    public void create(Siteuser siteuser) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            em.persist(siteuser);
            if (usergroupid != null) {
                usergroupid.getSiteuserCollection().add(siteuser);
                usergroupid = em.merge(usergroupid);
            }
            if (merchantid != null) {
                merchantid.getSiteuserCollection().add(siteuser);
    ...
    public void destroy(Integer id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Usergroup usergroupid = siteuser.getUsergroupid();
            if (usergroupid != null) {
                usergroupid.getSiteuserCollection().remove(siteuser);
                usergroupid = em.merge(usergroupid);
            }
            Merchant merchantid = siteuser.getMerchantid();
            if (merchantid != null) {
                merchantid.getSiteuserCollection().remove(siteuser);
                merchantid = em.merge(merchantid);
            }
            em.remove(siteuser);
            utx.commit();
