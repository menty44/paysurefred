...
import paygate.objects.CountryFacade;
...
public class CountryController implements Serializable {
    ...
    @EJB
    private paygate.objects.CountryFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        ...
        List<Country> countryList = ejbFacade.findAll();
        SelectItem[] countries = new SelectItem[countryList.size()];
        Iterator i = countryList.iterator();
        int x = 0;
        while (i.hasNext()) {
            Country country = (Country) i.next();
            countries[x++] = new SelectItem(country, country.getName());
        }
        return countries;
