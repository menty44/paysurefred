...
public class authenticator extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, NamingException {
        ...
        String code = " ";
        //Purchase purchase = new Purchase();
        String systemtraceno = request.getParameter("name"); 
        ...
        try {
            ...
            //purchase = (Purchase) em.createNamedQuery("Purchase.findByReferenceno").setParameter("referenceno", referenceno).getSingleResult();
            purchase = dbb.findByRefNo(referenceno);
            ...
            try {
                ...
                //Responsecode responsecode = (Responsecodeold) em.createNamedQuery("Responsecodeold.findByCode").setParameter("code", code).getSingleResult();
                Cardtype cardtype = new Cardtype(1);
                //responsecode = dbb.findResponsecode(code);
                responsecode = dbb.findResCode(cardtype, code);
