...
@SequenceGenerator(name = "Batchitem",sequenceName = "batchitem_id_sequence", initialValue=1)
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "Batchitem.filter", query = "SELECT b FROM Batchitem b"),
    @NamedQuery(name = "Batchitem.filtered", query = "SELECT b FROM Batchitem b WHERE b.batchheaderId.id = :key")})
...
public class Batchitem implements Serializable {
    ...
    @Id
    //@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="Batchitem")
