    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                transactionmpesa = transaction.pullMpesaRecord(code);
                if (transactionmpesa.getMpesacode().compareTo(code) == 0) {
            ...
            /*
             * transactionmpesa = transaction.pullMpesaRecord(code); if
             * (transactionmpesa.getMpesacode().compareTo(code) == 0) {
