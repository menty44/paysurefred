...
import paygate.objects.TransactionFacade;
...
public class TransactionController implements Serializable {
    ...
    @EJB
    private paygate.objects.TransactionFacade ejbFacade;
    ...
    public static class TransactionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Transaction) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TransactionController.class.getName());
            }
        }
    }    
    public List<Transaction> getThem(){
        emf=Persistence.createEntityManagerFactory("adminPU");
        em=emf.createEntityManager();
        List<Transaction> l=(List<Transaction>)em.createQuery("select t from Transaction t order by t.id desc").getResultList();
        return l;    
    }   
}
