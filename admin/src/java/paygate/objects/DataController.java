...
import paygate.objects.DataFacade;
...
public class DataController implements Serializable {
    ...
    @EJB
    private paygate.objects.DataFacade ejbFacade;
    ...
    public static class DataControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Data) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + DataController.class.getName());
            }
        }
    }
}
