...
public class Merchant implements Serializable {
    ...
    @JoinColumn(name = "acquireridkenswitch", referencedColumnName = "id")
    @ManyToOne
    private Acquirer acquireridkenswitch;
    @JoinColumn(name = "acquireridvisa", referencedColumnName = "id")
    @ManyToOne
    private Acquirer acquireridvisa;
    ...
    private Boolean usd;
    @Size(max = 2147483647)
    @Column(name = "vpcaccesscode")
    private String vpcaccesscode;
    @Size(max = 2147483647)
    @Column(name = "vpcmerchantid")
    ...
    public void setLiveusd(String liveusd) {
        this.liveidusd = liveusd;
    }
    ...
    public String getVpcmerchantid() {
        return vpcmerchantid;
    }

    public void setVpcmerchantid(String vpcmerchantid) {
    ...
    public Acquirer getAcquireridkenswitch() {
        return acquireridkenswitch;
    }

    public void setAcquireridkenswitch(Acquirer acquireridkenswitch) {
        this.acquireridkenswitch = acquireridkenswitch;
    }

    public Acquirer getAcquireridvisa() {
        return acquireridvisa;
    }

    public void setAcquireridvisa(Acquirer acquireridvisa) {
        this.acquireridvisa = acquireridvisa;
    }
