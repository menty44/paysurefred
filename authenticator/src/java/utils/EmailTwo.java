...
public class EmailTwo {
    ...
    public String sendEmail(Purchase purchase, String to, String refno, String tdt) {
        ...
        try {
            ...
            msg = msg + "\n" + purchase.getClientname() + " you have made a transaction of amount:" + purchase.getAmount() + " and Reference No: " + purchase.getReferenceno() + " to merchant " +purchase.getMerchantid().getName();
