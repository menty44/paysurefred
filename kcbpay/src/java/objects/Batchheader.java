...
@NamedQueries({
    ...
    @NamedQuery(name = "Batchheader.findByMerchantid", query = "SELECT b FROM Batchheader b WHERE b.merchantid = :merchantid"),
    @NamedQuery(name = "Batchheader.findByCurrency", query = "SELECT b FROM Batchheader b WHERE b.currency = :currency"),
    @NamedQuery(name = "Batchheader.findByEmailstatus", query = "SELECT b FROM Batchheader b WHERE b.emailstatus = :emailstatus")})
public class Batchheader implements Serializable {
    ...
    public String toString() {
        return "objects.Batchheader[ id=" + id + " ]";
    }
