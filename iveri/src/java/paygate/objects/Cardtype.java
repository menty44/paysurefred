...
public class Cardtype implements Serializable {
    ...
    private Collection<Responsecode> responsecodeCollection;
    ...
    @XmlTransient
    public Collection<Responsecode> getResponsecodeCollection() {
        return responsecodeCollection;
    }

    public void setResponsecodeCollection(Collection<Responsecode> responsecodeCollection) {
        this.responsecodeCollection = responsecodeCollection;
    }
