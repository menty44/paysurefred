...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Transaction.findAll", query = "SELECT t.merchantname, SUM(t.amount) FROM Transaction t where t.processed=false and t.statusid=:status GROUP BY t.merchantname"),
    @NamedQuery(name = "Transaction.findById", query = "SELECT t FROM Transaction t WHERE t.id = :id"),
    @NamedQuery(name = "Transaction.findMerchantTransactions", query = "SELECT t FROM Transaction t where t.processed = false and t.statusid = :status and t.merchantname = :merchantname and t.cardtype = :cardtype"),
