...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Merchant.findAll", query = "SELECT m FROM Merchant m WHERE m.statusid = :code order by m.name asc"),
    @NamedQuery(name = "Merchant.findAllSort", query = "SELECT m FROM Merchant m WHERE m.countryid= :cid and m.categoryid= :ctid and m.statusid = :code order by m.name asc"),
    ...
    @NamedQuery(name = "Merchant.findBySorted", query = "SELECT m FROM Merchant m WHERE m.countryid = :countryid and m.categoryid = :categoryid"),
