...
public class Config implements Serializable {
    ...
    @SequenceGenerator(name = "configGenerator", catalog = "paygate", schema = "public", sequenceName = "config_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "configGenerator")
    @Id
