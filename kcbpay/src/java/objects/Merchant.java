...
@NamedQueries({
    ...
    @NamedQuery(name = "Merchant.findByEnterpriseid", query = "SELECT m FROM Merchant m WHERE m.enterpriseid = :enterpriseid"),
    @NamedQuery(name = "Merchant.findByEnterpriseidusd", query = "SELECT m FROM Merchant m WHERE m.enterpriseidusd = :enterpriseidusd"),
    @NamedQuery(name = "Merchant.findByWebsite", query = "SELECT m FROM Merchant m WHERE m.website = :website")})
public class Merchant implements Serializable {
    ...
    @JoinColumn(name = "acquirerid", referencedColumnName = "id")
    @ManyToOne
    private Acquirer acquirerid;
    @OneToMany(mappedBy = "merchantid")
    ...
    public Acquirer getAcquirerid() {
        return acquirerid;
    }

    public void setAcquirerid(Acquirer acquirerid) {
