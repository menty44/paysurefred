...
import paygate.controllers.GenderFacade;
...
@ManagedBean(name = "genderController")
@SessionScoped
public class GenderController implements Serializable {
    ...
    @EJB
    private paygate.controllers.GenderFacade ejbFacade;
    ...
    public static class GenderControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Gender) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + GenderController.class.getName());
            }
        }
    }
}
